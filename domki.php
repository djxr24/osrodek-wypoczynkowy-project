		...
		if (isset($_POST['edytuj'])) // jeśli kliknięto 'edytuj'
		{
			if (isset($_POST['lista'])) // jeśli wybrano rekord z formularza
			{
				...
				if ($row = mysql_fetch_row($edytowany_rekord))
				{
					...
					echo"<input type='hidden' name='wartosci[]' value =".$nazwa." />"; //stare wartosci
					echo"<input type='hidden' name='wartosci[]' value =".$opis." />";
					echo"<input type='hidden' name='wartosci[]' value =".$cena." />";
					...
					echo "<input type='hidden' name='strona_wroc' value ='domki.php' />";
					echo "<input type='hidden' name='komunikat_niepodzenie' value ='Dziewczyno, ty się ubierz!!' />";

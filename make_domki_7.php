...
$sql="ALTER TABLE rezerwacja  
ADD CONSTRAINT rezerwacja_ibfk_1 FOREIGN KEY (ID_domek) REFERENCES domek (ID) ON DELETE CASCADE ON UPDATE CASCADE";

//$sql="ALTER TABLE rezerwacja 
//DROP COLUMN rezerwacja_ibfk_2";

//$results=mysql_query($sql) or die ('Rezerwacja DROP Wykonanie zapytania nie powodło sie. Błąd:' .mysql_error());


$sql="ALTER TABLE rezerwacja  
ADD CONSTRAINT rezerwacja_ibfk_2 FOREIGN KEY (ID_klient) REFERENCES klient (ID) ON DELETE CASCADE ON UPDATE CASCADE";
...
$sql="ALTER TABLE promocja
ADD  CONSTRAINT promocja_ibfk_1 FOREIGN KEY (ID_domek) REFERENCES domek (ID) ON DELETE CASCADE ON UPDATE CASCADE";
...
$sql="ALTER TABLE usterka
ADD CONSTRAINT usterka_ibfk_1 FOREIGN KEY (ID_domek) REFERENCES domek (ID) ON DELETE CASCADE ON UPDATE CASCADE";
...
$sql="ALTER TABLE zamowienia  
ADD  CONSTRAINT zamowienia_ibfk_1 FOREIGN KEY (ID_Domek) REFERENCES domek (ID) ON DELETE CASCADE ON UPDATE CASCADE";
